...
iso_name = "debian-13.4.0-arm64-netinst.iso"
iso_path = "13.4.0/arm64/iso-cd"
iso_checksum = "file:https://cdimage.debian.org/debian-cd/13.4.0/arm64/iso-cd/SHA256SUMS"
