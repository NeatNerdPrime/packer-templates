...
build {
  ...
  provisioner "shell" {
    environment_vars = [
      "OS_VER=v${var.os_ver}",
      "VIRTUALBOX_GUEST_ADDITIONS=virtualbox-guest-additions-x11=7.0.22-r0"
    ]
    only = [
      "virtualbox-iso.*"
    ]
  ...
  provisioner "shell" {
    environment_vars = [
      ...
      "OS_VER=v${var.os_ver}",
      "XF86_INPUT=xf86-input-evdev=2.11.0-r0",
      "XF86_VIDEO=xf86-video-vmware=13.4.0-r4"
    ]
    only = [
      "vmware-iso.*"
    ]
