# Packer templates for Alpine Linux 3.23.3

Templates to create Vagrant boxes for Alpine Linux 3.23.3. (x86_64,
x86, and aarch64)
...
packer build -only=virtualbox-iso.default \
  -var-file=vars-alpine-standard-3.23-x86_64.pkrvars.hcl \
  alpine-3.23-minimal.pkr.hcl
```

You will find a vagrant box file named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64`
to your box list by the following command:

```
vagrant box add \
  Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-virtualbox.box \
  --name Alpine-standard-3.23-minimal-v323.3.20260127-x86_64 \
  --provider virtualbox
```
...
You will find a vagrant box file named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-vmware.box` in the
same directory after the command has succeeded.

Then you can add the box named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64` to your box list
by the following command:

```
vagrant box add \
  Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-vmware.box \
  --name Alpine-standard-3.23-minimal-v323.3.20260127-x86_64 \
  --provider vmware
```
...
You will find a vagrant box file named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-libvirt.box` in the
same directory after the command has succeeded.
...
```
vagrant box add \
  Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-libvirt.box \
  --name Alpine-standard-3.23-minimal-v323.3.20260127-x86_64 \
  --provider libvirt
```
...
You will find a vagrant box file named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-hyperv.box`
...
You will find a vagrant box file named
`Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-parallels.box` in
the same directory after the command has succeeded.
...
```
vagrant box add \
  Alpine-standard-3.23-minimal-v323.3.20260127-x86_64-parallels.box \
  --name Alpine-standard-3.23-minimal-v323.3.20260127-x86_64 \
  --provider parallels
```
...
* `alpine-3.23-minimal.pkr.hcl` - Alpine Linux 3.23.3
* `alpine-3.23-docker.pkr.hcl` - Alpine Linux 3.23.3 with [Docker] and
  [Docker Compose]
* `alpine-3.23-dwm.pkr.hcl` - Alpine Linux 3.23.3 with [X.org][],
  [dwm][], [dmenu][], [st][], [SLiM][], and [xrdp][].
* `alpine-3.23-xfce.pkr.hcl` - Alpine Linux 3.23.3 with [Xfce][] and
  [xrdp][].
...
Instead of `vars-alpine-standard-3.23-*.pkrvars.hcl` files you can use
`vars-alpine-virt-3.23-*.pkrvars.hcl`.  These files instruct to use ISO
