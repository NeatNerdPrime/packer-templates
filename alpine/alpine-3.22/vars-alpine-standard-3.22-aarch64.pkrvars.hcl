...
iso_image = "alpine-standard-3.22.3-aarch64.iso"
iso_checksum = "file:https://dl-cdn.alpinelinux.org/alpine/v3.22/releases/aarch64/alpine-standard-3.22.3-aarch64.iso.sha256"
cpu = "aarch64"
