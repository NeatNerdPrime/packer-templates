# Packer templates for Alpine Linux 3.20.9

Templates to create Vagrant boxes for Alpine Linux 3.20.9. (x86_64,
x86, and aarch64)
...
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64`
to your box list by the following command:

```
vagrant box add \
  Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-virtualbox.box \
  --name Alpine-standard-3.20-minimal-v20.9.20260127-x86_64 \
  --provider virtualbox
```
...
You will find a vagrant box file named
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-vmware.box` in the
same directory after the command has succeeded.

Then you can add the box named
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64` to your box list
by the following command:

```
vagrant box add \
  Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-vmware.box \
  --name Alpine-standard-3.20-minimal-v20.9.20260127-x86_64 \
  --provider vmware
```
...
You will find a vagrant box file named
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-libvirt.box` in the
same directory after the command has succeeded.
...
```
vagrant box add \
  Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-libvirt.box \
  --name Alpine-standard-3.20-minimal-v20.9.20260127-x86_64 \
  --provider libvirt
```
...
You will find a vagrant box file named
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-hyperv.box`
...
You will find a vagrant box file named
`Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-parallels.box` in
the same directory after the command has succeeded.
...
```
vagrant box add \
  Alpine-standard-3.20-minimal-v20.9.20260127-x86_64-parallels.box \
  --name Alpine-standard-3.20-minimal-v20.9.20260127-x86_64 \
  --provider parallels
```
...
* `alpine-3.20-minimal.pkr.hcl` - Alpine Linux 3.20.9
* `alpine-3.20-docker.pkr.hcl` - Alpine Linux 3.20.9 with [Docker] and
  [Docker Compose]
* `alpine-3.20-dwm.pkr.hcl` - Alpine Linux 3.20.9 with [X.org][],
  [dwm][], [dmenu][], [st][], [SLiM][], and [xrdp][].
* `alpine-3.20-xfce.pkr.hcl` - Alpine Linux 3.20.9 with [Xfce][] and
  [xrdp][].
...
Copyright &copy; 2025, 2026 Upperstream Software.
