...
The following command will build a VM image on your ESXi:
    ...
    packer build -only=vmware-iso.esxi netbsd-11-minimal.pkr.hcl
...
From the terminal, invoke the following command for Hyper-V provider:
    ...
    packer build -only=hyperv-iso -var hyperv_ssh_host=192.168.1.2 \
        ...
        -var hyperv_gateway=192.168.1.1 netbsd-11-minimal.pkr.hcl
...
aarch64 boxes:
    ...
    packer build -var-file=vars-netbsd-11-aarch64.pkrvars.hcl netbsd-11-minimal.pkr.hcl

and using `vars-netbsd-11-i386.pkrvars.hcl` generates i386
boxes:

    packer build -var-file vars-netbsd-11-i386.pkrvars.hcl netbsd-11-minimal.pkr.hcl
...
Copyright &copy; 2026 Upperstream.
